...
export default function ProductsPage() {
  ...
  const columns = [
    ...
    { key: 'leadTime', label: 'Lead Time', render: (p: DemoProduct) => p.leadTime > 0 ? `${p.leadTime} days` : 'In stock' },
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-gray-900 mb-6">Products and States</h1>
